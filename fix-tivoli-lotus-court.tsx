/**
 * Fixed version of TivoliLotusCourtPage.tsx
 * The issue was that useHotelMedia was being called with empty string before hotelData was loaded
 */
...
const TivoliLotusCourtPage: React.FC = () => {
  ...
  // Hotel data with caching - this was the source of the error
  const {
    data: hotelData,
    loading,
    error,
