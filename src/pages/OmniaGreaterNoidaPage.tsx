/**
 * Enhanced Omnia Greater Noida Page with Progressive Loading
 * Comprehensive, database-driven detail page for Omnia by Tivoli - Greater Noida
...
const EnhancedOmniaGreaterNoidaPage: React.FC = () => {
  ...
  const {
    ...
    quickStats,
    socialMedia,
  } = useTivoliNewDelhi(hotelSlug || 'omnia-greater-noida');
  ...
  const { 
    ...
    error: roomsError 
  } = useHotelRooms('a2b8c9d0-1234-5678-9abc-def012345678');
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          {showSkeletonUI ? (
            ...
            <OverviewSection
              ...
              location={hotelData.address.city}
              additionalDescription={`Located in the prestigious area of ${hotelData.address.city}, Omnia by Tivoli offers an unmatched blend of contemporary luxury and modern sophistication. Our hotel features elegantly appointed rooms, world-class dining venues, spectacular event spaces, and comprehensive amenities designed to exceed every expectation.`}
        ...
        <div className="space-y-16">
          {showSkeletonUI ? (
            ...
            <ContactSection
              ...
              mapEmbedUrl="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.0574825847896!2d77.39000000000001!3d28.574000000000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce626851f7009%3A0x621185133cdf47ed!2sOmnia%20by%20Tivoli%2C%20Greater%20Noida!5e0!3m2!1sen!2sin!4v1710934800000!5m2!1sen!2sin"
            />
          ) : (
            <SkeletonContact />
          )}
...
export default EnhancedOmniaGreaterNoidaPage;